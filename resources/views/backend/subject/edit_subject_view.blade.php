   ...
   <!-- start page title -->
                        ...
                        <div class="card">
                                    ...
                                    <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="subject_name"  type="text" value="{{$subject->subject_name}}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="subject_code"  type="text" value="{{$subject->subject_code}}">
                                            </div>
                                        </div>
