                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">View Manage Info</h4>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                alt="Header Avatar" style="width: 35px;height:35px;padding:0px; margin-left:30px"></td>
                                                ...
                                                <td style="text-align: center; font-size:20px">
                                                  <a href="{{route('edit.student',$result->student)}}" style="color: #444;margin-right:30px"> <i class="fas fa-edit"></i> </a>
