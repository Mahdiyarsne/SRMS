                        ...
                        <div class="card">
                                    ...
                                    <div class="row mb-3">
                                      ...
                                      <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-check-input" name="gender" value="Male" type="radio" {{$student->gender == 'Male' ? 'checked' : ''}}>
                                                 <label class="form-check-label" for="formRadios1">Male</label>

                                                  <input class="form-check-input" name="gender" value="Female" type="radio"  {{$student->gender == 'Female' ? 'checked' : ''}}>
