                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Student Addmission</h4>
                        ...
                        <div class="card">
                                    ...
                                    <div class="row mb-3">
                                      ...
                                      <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-check-input" name="gender" value="Male" type="radio" checked="">
                                                 <label class="form-check-label" for="formRadios1">Male</label>

                                                  <input class="form-check-input" name="gender" value="Female" type="radio" checked="">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <!-- end row -->
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Create Student</button>
